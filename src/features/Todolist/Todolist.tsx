...
export const Todolist: React.FC<TodolistProps> = React.memo((props) => {
	...
	const addItemHandler = useCallback((value: string) => addTask(todolistId, value), [addTask, todolistId]);
	...
	return (
		<Paper elevation={3} className={s.todolist}>
			...
			<div className={s.title__block}>
				<EditableInput changeTodolistTitle={changeTodolistTitleHandler} value={title} />
			</div>
